...
/**
 * Integration tests for FreeDSx SNMP client that require a real APC PDU device.
 *
 ...
 * @group freedsx
 */
class ApcPduFreeDsxIntegrationTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->pdu = ApcPduFactory::snmpV3FreeDsx($host, $user, $authPass, $privPass ?: '');
    }
