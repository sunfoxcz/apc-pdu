...
class OutletMetricTest extends TestCase
{
    ...
    public function testUnits(): void
    {
        ...
        $this->assertSame('', OutletMetric::EnergyResetTimestamp->unit());
    ...
    public function testEnumValues(): void
    {
        ...
        $this->assertSame('energy_reset_timestamp', OutletMetric::EnergyResetTimestamp->value);
    ...
    public function testIsString(): void
    {
        ...
        $this->assertTrue(OutletMetric::EnergyResetTimestamp->isString());
    ...
    public function testIsEnum(): void
    {
        ...
        $this->assertFalse(OutletMetric::EnergyResetTimestamp->isEnum());
    ...
    public function testIsInteger(): void
    {
        ...
        $this->assertFalse(OutletMetric::EnergyResetTimestamp->isInteger());
    ...
    public function testAllCasesExist(): void
    {
        ...
        $this->assertContains(OutletMetric::EnergyResetTimestamp, $cases);
